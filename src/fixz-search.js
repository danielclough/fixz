...
(function () {
  ...
  function toggleSearch() {
    const searchWrapperEl = document.getElementById("fixz-search-wrapper");
    const searchResultsEl = document.getElementById("fixz-search-results");
  ...
  if (null == window.fixz) window.fixz = {};
  window.fixz.toggleSearch = toggleSearch;
  window.fixz.initSearchButton = initSearchButton;
})();
